window.addEventListener("load", function(){
    ...
    if(productosEnCarrito == null){
        ...
        for(producto of productosEnCarrito){
            ...
            "<article class='articulosCarrito' id='"+producto.id+"'><div class='productoImagenDescripcion'><button class='botonQuitar'><i class='fas fa-times' id='quitar-"+producto.id+"'></i></button><img src='"+ producto.img +"' alt='producto1' class='imgProductos'><div><h3 class='tituloProducto'>"+ producto.nombre+"</h3><p class='precios'>Precio:</p><p class='precios'>"+producto.precio +" ETH</p></div></div><div class='precioProd'></div></article>"
